...
edit_cache:
	...
	/usr/local/Cellar/cmake/3.13.1/bin/cmake -E echo No\ interactive\ CMake\ dialog\ available.
.PHONY : edit_cache
...
test:
	...
	/usr/local/Cellar/cmake/3.13.1/bin/ctest --force-new-ctest-process $(ARGS)
.PHONY : test
